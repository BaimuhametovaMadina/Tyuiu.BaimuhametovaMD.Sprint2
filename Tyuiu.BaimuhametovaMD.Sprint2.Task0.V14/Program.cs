using Tyuiu.BaimuhametovaMD.Sprint2.Task0.V14.Lib;

///Написать программу из операций сравнений (==, !=, <, >, <=, >=, последовательность операций не должна нарушаться) 
///и арифметических выражений, 
///которая вернет логическую последовательность(массив): (True, False, True, False, True, False), при x = 1075, y = 754

namespace Tyuiu.BaimuhametovaMD.Sprint2.Task0.V14
{
